 ...
 */
router.post("/register", rate_limit_1.authLimiter, auth_controller_1.AuthController.register);
/**
 * @swagger
 * /auth/login:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/login", rate_limit_1.authLimiter, auth_controller_1.AuthController.login);
/**
 * @swagger
 * /auth/google:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/verify-otp", rate_limit_1.authLimiter, auth_controller_1.AuthController.verifyOtp);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/forgot-password", rate_limit_1.authLimiter, auth_controller_1.AuthController.forgotPassword);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/verify-reset-otp", rate_limit_1.authLimiter, auth_controller_1.AuthController.verifyResetOtp);
/**
 * @swagger
 * /auth/reset-password:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/reset-password", rate_limit_1.authLimiter, auth_controller_1.AuthController.resetPassword);
/**
 * @swagger
 * /auth/push-token:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/push-token", auth_middleware_1.authMiddleware, auth_controller_1.AuthController.updatePushToken);
