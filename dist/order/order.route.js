...
const customerAuth = [auth_middleware_1.authMiddleware, (0, auth_middleware_1.roleMiddleware)(["CUSTOMER"])];
/**
 * @swagger
 * tags:
 *   name: Orders
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/", customerAuth, order_controller_1.OrderController.createOrder);
/**
 * @swagger
 * /orders/quote:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post("/quote", customerAuth, order_controller_1.OrderController.getQuote);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/customer/:customerId", customerAuth, order_controller_1.OrderController.getAllOrders);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/single/:reference", customerAuth, order_controller_1.OrderController.getSingleOrder);
