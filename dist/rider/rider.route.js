...
const riderAuth = [auth_middleware_1.authMiddleware, (0, auth_middleware_1.roleMiddleware)(["RIDER"])];
/**
 * @swagger
 * tags:
 *   name: Riders
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/orders/available", riderAuth, rider_controller_1.RiderController.getAvailableOrders);
/**
 * @swagger
 * /rider/orders/active:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/orders/active", riderAuth, rider_controller_1.RiderController.getActiveOrder);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch("/orders/:id/accept", riderAuth, rider_controller_1.RiderController.acceptOrder);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch("/orders/:id/pickup", riderAuth, rider_controller_1.RiderController.confirmPickup);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch("/orders/:id/deliver", riderAuth, rider_controller_1.RiderController.confirmDelivery);
// ─────────────────────────────────────────────
// EARNINGS & HISTORY
// ─────────────────────────────────────────────
/**
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/earnings", riderAuth, rider_controller_1.RiderController.getEarnings);
/**
 * @swagger
 * /rider/history:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/history", riderAuth, rider_controller_1.RiderController.getHistory);
// ─────────────────────────────────────────────
// PAYOUT & STATUS
// ─────────────────────────────────────────────
router.post("/payout", riderAuth, rider_controller_1.RiderController.requestPayout);
router.get("/transactions", riderAuth, rider_controller_1.RiderController.getTransactions);
router.patch('/status', riderAuth, rider_controller_1.RiderController.updateStatus);
exports.default = router;
//# sourceMappingURL=rider.route.js.map