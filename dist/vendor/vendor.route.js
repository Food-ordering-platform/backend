...
const vendorAuth = [auth_middleware_1.authMiddleware, (0, auth_middleware_1.roleMiddleware)(["VENDOR"])];
/**
 * @swagger
 * tags:
 *   name: Vendors
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/:restaurantId/orders", vendorAuth, vendor_controller_1.VendorController.getVendorOrders);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch("/order/:id/accept", vendorAuth, vendor_controller_1.VendorController.acceptOrder);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch("/order/:id/request-rider", vendorAuth, vendor_controller_1.VendorController.requestRider);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch("/order/:id/cancel", vendorAuth, vendor_controller_1.VendorController.cancelOrder);
// ─────────────────────────────────────────────
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/earnings", vendorAuth, vendor_controller_1.VendorController.getEarnings);
/**
 * @swagger
 * /vendor/transactions:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/transactions", vendorAuth, vendor_controller_1.VendorController.getTransactions);
router.post("/payout", vendorAuth, vendor_controller_1.VendorController.requestPayout);
